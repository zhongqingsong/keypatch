...
class Keypatch_Plugin_t(idaapi.plugin_t):
    ...
    def init(self):
        ...
        try:
            Kp_MC_Patcher.register(self, "打补丁")
            Kp_MC_Fill_Range.register(self, "填充已选中范围")
            Kp_MC_Undo.register(self, "撤销上一步")
            Kp_MC_Search.register(self, "搜索")
            Kp_MC_About.register(self, "关于/帮助")
        except:
            pass
